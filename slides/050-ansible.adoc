...
Ansible has a notion of roles and playbook we'll talk about in the next slides, so we can separate/regroup our tasks. It also has a huge community we can rely on to use existing roles to configure your docker installation as example.
...
video::demo.mp4[width=1000,opts="autoplay,loop,muted"]

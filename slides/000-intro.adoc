...
Easy to maintain : I don't want to spend hours to configure something... To configure my laptop, so I can work in the end.

Multiple laptop : I'm working on multiple laptop, so I have to take that into account too, since I share some configuration between my personal and professional laptop, I need a portable solution, and I don't want to have to start over or duplicate it.

...
This makes the maintainability of this solution not too good, as you need to maintain two folders/repository to your professional and personal workstation.
